...
class NativeImpl implements Native {
  ...
  Future<void> bleConnect({required BleAddress address, dynamic hint}) {
    var arg0 = _platform.api2wire_box_autoadd_ble_address(address);
...
// Section: wire2api
  ...
  BleDevice _wire2api_ble_device(dynamic raw) {
    ...
    return BleDevice(
      address: _wire2api_ble_address(arr[0]),
...
// Section: api2wire
  ...
  @protected
  ffi.Pointer<wire_BleAddress> api2wire_box_autoadd_ble_address(
      BleAddress raw) {
    final ptr = inner.new_box_autoadd_ble_address_0();
    _api_fill_to_wire_ble_address(raw, ptr.ref);
    return ptr;
  }
...
// Section: api_fill_to_wire
  ...
  void _api_fill_to_wire_ble_address(
      BleAddress apiObj, wire_BleAddress wireObj) {
    wireObj.address = api2wire_u8_array_6(apiObj.address);
  }

  void _api_fill_to_wire_box_autoadd_ble_address(
      BleAddress apiObj, ffi.Pointer<wire_BleAddress> wireObj) {
    _api_fill_to_wire_ble_address(apiObj, wireObj.ref);
  }
}
...
class NativeWire implements FlutterRustBridgeWireBase {
  ...
  void wire_ble_connect(
    int port_,
    ffi.Pointer<wire_BleAddress> address,
  ) {
  ...
  late final _wire_ble_connectPtr = _lookup<
      ffi.NativeFunction<
          ffi.Void Function(
              ffi.Int64, ffi.Pointer<wire_BleAddress>)>>('wire_ble_connect');
  late final _wire_ble_connect = _wire_ble_connectPtr
      .asFunction<void Function(int, ffi.Pointer<wire_BleAddress>)>();
  ...
  ffi.Pointer<wire_BleAddress> new_box_autoadd_ble_address_0() {
    return _new_box_autoadd_ble_address_0();
  }

  late final _new_box_autoadd_ble_address_0Ptr =
      _lookup<ffi.NativeFunction<ffi.Pointer<wire_BleAddress> Function()>>(
          'new_box_autoadd_ble_address_0');
  late final _new_box_autoadd_ble_address_0 = _new_box_autoadd_ble_address_0Ptr
      .asFunction<ffi.Pointer<wire_BleAddress> Function()>();
...
final class wire_BleAddress extends ffi.Struct {
